...
const EN: Record<string, string> = {
  ...
  "隐私政策": "Privacy Policy",
  "我们非常重视你的隐私。载思 仅在通话进行时采集你的语音用于实时对话,": "We take your privacy seriously. ZaiSi only captures your voice during a call for real-time conversation,",
  ...
  "服务内容": "The service",
  ":载思 提供与 AI 角色的语音通话服务。AI 生成的内容仅供陪伴与娱乐,不构成任何专业(医疗、法律、心理等)建议。": ": ZaiSi provides voice calls with AI characters. AI-generated content is for companionship and entertainment only and is not professional (medical, legal, psychological, etc.) advice.",
  "账户": "Account",
